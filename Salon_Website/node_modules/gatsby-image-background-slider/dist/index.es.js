...
var BackgroundSlider = function BackgroundSlider(_ref) {
	...
	var imgs = nodes.map(function (data, index) {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ ref: bgRefs[index] },
				React.createElement(Img, _extends({ fluid: data.childImageSharp.fluid, style: _extends({}, backgroundStyle, style) }, imageProps))
			),
			React.createElement(
				'div',
	...
	var timeoutHandleRef = useRef(timeoutHandle);
...
var Pagination = function Pagination(_ref2) {
	...
	return React.createElement(
		...
		Array.from(Array(callbacks.getCount()).keys()).map(function (index) {
			return React.createElement(
				'span',
				{ role: 'button', ref: buttonRefs[index] = React.createRef(),
					key: index,
					style: {
						userSelect: 'none',
